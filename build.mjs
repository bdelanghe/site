...
// The typed-symbol catalog + grounding registry that the `audit` workflow gates on are
// generated by audit-catalog.mjs into data/audit/ (not emitted here) — one canonical
// catalog generator, consumed by the upstream string-audit reusable workflow.
